...
.. code-block:: shell
  ...
  wget --no-check-certificate https://launchpad.net/plone/6.0/6.0-dev/+download/Plone-6.0-dev-UnifiedInstaller-1.0.tgz

Extract the downloaded file:

.. code-block:: shell

  tar -xf Plone-6.0-dev-UnifiedInstaller-1.0.tgz

Go the folder containing installer script:

.. code-block:: shell

  cd Plone-6.0-dev-UnifiedInstaller-1.0
