...
.. code-block:: shell
  ...
  $ wget --no-check-certificate https://launchpad.net/plone/5.0/5.1.1/+download/Plone-5.1.1-UnifiedInstaller.tgz

Extract the downloaded file:

.. code-block:: shell

  $ tar -xf Plone-5.1.1-UnifiedInstaller.tgz

Go the folder containing installer script:

.. code-block:: shell

  $ cd Plone-5.1.1-UnifiedInstaller
