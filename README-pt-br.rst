...
.. code-block:: shell
  ...
  wget --no-check-certificate https://launchpad.net/plone/5.2/5.2.10.2/+download/Plone-5.2.10.2-UnifiedInstaller-1.0.tgz
...
.. code-block:: shell
  ...
  tar -xf Plone-5.2.10.2-UnifiedInstaller-1.0.tgz
