==============================
Plone 4.3.15: Unified Installer
==============================
...
This version includes Plone 4.3.15, Zope 2.13.x, and uses Python 2.7.x.
...
To install Plone 4.3.15 in a stand-alone (single Zope instance) configuration:
