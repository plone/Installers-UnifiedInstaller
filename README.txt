==============================
Plone 4.3.18: Unified Installer
==============================
...
This version includes Plone 4.3.18, Zope 2.13.x, and uses Python 2.7.x.
...
To install Plone 4.3.18 in a stand-alone (single Zope instance) configuration:

* cd to the installer directory and issue the following command::

    >> ./install.sh standalone

To install Plone 4.3.18 in a ZEO Cluster (ZEO server, 2 clients) configuration:
